...
const CSTHLayout = "2006-01-02T15:04Z"
...
func ParseUTCInLocation(date string) (time.Time, error) {
	return time.ParseInLocation(UTCLayout, date, cst)
}
func ParseInLocation(date string, layout string) (time.Time, error) {
